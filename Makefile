...
FASTLY_COMPUTE_AT_EDGE_SERVICE_NAME := fastly-compute-at-edge-template
...
FASTLY_CLI_GENERATED_PKG_TAR_BALL := $(FASTLY_CLI_GENERATED_PKG_DIR)/$(FASTLY_COMPUTE_AT_EDGE_SERVICE_NAME).tar.gz
FASTLY_CLI_ARCHIVED_WASM_BINARY := $(FASTLY_CLI_GENERATED_PKG_DIR)/$(FASTLY_COMPUTE_AT_EDGE_SERVICE_NAME)/bin/main.wasm
